...
public class EleftheriaPrimeService extends AccessibilityService {
    ...
    public void onServiceConnected() {
        instance = this;
        Log.d(TAG, "EleftheriaPrime Accessibility Service CONNECTED — Ghost Operator ACTIVE");
        startHttpServer();
    }
    ...
    private void startHttpServer() {
        serverThread = new Thread(() -> {
            try {
                ...
                Log.d(TAG, "EleftheriaPrime HTTP server listening on port " + PORT);
    ...
    private String processCommand(String headers, String body) {
        try {
            ...
            if (path.equals("/ping")) {
                return "{\"status\":\"ok\",\"agent\":\"EleftheriaPrime\",\"version\":\"1.0\",\"mode\":\"GhostOperator\"}";
            }
